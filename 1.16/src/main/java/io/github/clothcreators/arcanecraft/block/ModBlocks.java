...
public class ModBlocks {
	...
	public static final Block CRYSTAL_ORE = register("crystal_ore", new CrystalOreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.METAL).strength(2.0F, 17.5F).breakByHand(false).breakByTool(FabricToolTags.PICKAXES, 2)));
