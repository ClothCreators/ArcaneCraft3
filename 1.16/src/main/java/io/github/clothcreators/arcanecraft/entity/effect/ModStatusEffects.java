...
public class ModStatusEffects {
	...
	public static final StatusEffect CHARRED_STRIKE = register("charred_strike", new CharredStrikeEffect(StatusEffectType.BENEFICIAL, 0xFFD0_521D));
	public static final StatusEffect DRUID_BLESSING = register("druid_blessing", new DruidBlessingEffect(StatusEffectType.BENEFICIAL, 0xFFD0_521D));
